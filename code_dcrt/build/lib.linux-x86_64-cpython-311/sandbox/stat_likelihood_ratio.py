...
def stat_likelihood_ratio(X, X_tilde, y, method='lasso_cv', n_jobs=1, cv=5,
                          solver='liblinear', joblib_verbose=0):
    ...
    estimator = {
        ...
        'logistic_l1': LogisticRegressionCV(
            penalty='l1', max_iter=5e2, tol=1e-4, solver=solver, cv=cv,
            n_jobs=n_jobs),
    }
