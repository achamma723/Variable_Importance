...
list_cols = ['25056-2.0', '25057-2.0', '25060-2.0', '25059-2.0', '25061-2.0', '25058-2.0', '25009-2.0', '25025-2.0',
             ...
             '25001-2.0', '25005-2.0', '31-0.0', '21022-0.0', '20127-0.0', '1677-2.0', '1787-2.0',
...
col_pred = "21022-0.0"
df = pd.read_csv("ukbb_data_age_no_hot_encoding.csv", usecols=list_cols)
...
# df = pd.read_csv("Result_age_cpi_single.csv")
...
loop_params(X, y, list_cat, grps=grps_merged, param_grid=param_grid, n_jobs=n_jobs, k_fold=k_fold,
            title_res="Results_variables/Result_age_permfit_single.csv")