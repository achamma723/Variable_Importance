...
col_pred = "1558-2.0"
df = pd.read_csv("ukbb_data_alcohol_no_hot_encoding.csv", usecols=list_cols+[col_pred])
...
# df = pd.read_csv("Result_alcohol_cpi_single.csv")
...
loop_params(X, y, list_cat, grps=grps_merged, param_grid=param_grid, n_jobs=n_jobs, k_fold=k_fold,
            title_res="Results_variables/Result_alcohol_permfit_single.csv")
