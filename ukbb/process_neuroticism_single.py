...
col_pred = "20127-0.0"
df = pd.read_csv("ukbb_data_neuroticism_no_hot_encoding.csv", usecols=list_cols)
...
# df = pd.read_csv("Result_neuroticism_cpi_single.csv")
...
loop_params(X, y, list_cat, grps=grps_merged, param_grid=param_grid, n_jobs=n_jobs, k_fold=k_fold,
            title_res="Results_variables/Result_neuro_cpi_single.csv")
