...
col_pred = "1160-2.0"
df = pd.read_csv("ukbb_data_sleep_no_hot_encoding.csv", usecols=list_cols+[col_pred])
...
# df = pd.read_csv("Result_sleep_cpi_single.csv")
...
loop_params(X, y, list_cat, grps=grps_merged, param_grid=param_grid, n_jobs=n_jobs, k_fold=k_fold,
            title_res="Results_variables/Result_sleep_permfit_single.csv")
