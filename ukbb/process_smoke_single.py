...
list_cols = ['25056-2.0', '25057-2.0', '25060-2.0', '25059-2.0', '25061-2.0', '25058-2.0', '25009-2.0', '25025-2.0',
             ...
             '25001-2.0', '25005-2.0', '31-0.0', '21022-0.0', '20016-2.0', '20127-0.0', '1677-2.0', '1787-2.0',
...
col_pred = "20161-2.0"
df = pd.read_csv("ukbb_data_smoke_no_hot_encoding.csv", usecols=list_cols+[col_pred])


nominal_columns = list(pd.read_csv("ukbb_data_age_no_hot_encoding_nominal_columns.csv")['x'])
ordinal_columns = list(pd.read_csv("ukbb_data_age_no_hot_encoding_ordinal_columns.csv")['x'])
binary_columns = list(pd.read_csv("ukbb_data_age_no_hot_encoding_binary_columns.csv")['x'])
...
# df = pd.read_csv("Result_smoke_cpi_single.csv")
# df_imp = df[df['p_value'] < 0.001]['variable']
# # print(df_imp)
# # exit(0)

list_cat = {'nominal': nominal_columns, 'ordinal': ordinal_columns, 'binary': binary_columns}

# Remove smoking related variables
# df = df.drop(columns=['1239-2.0', '1249-2.0', '1259-2.0', '1269-2.0', '1279-2.0', '2644-2.0', '2867-2.0', '2877-2.0',
#                       '2887-2.0', '2897-2.0', '2907-2.0', '2926-2.0', '2936-2.0', '3436-2.0', '3446-2.0', '3456-2.0', 
#                       '3466-2.0', '3476-2.0', '3486-2.0', '3496-2.0', '3506-2.0', '5959-2.0', '6157-2.0', '6158-2.0'])
...
loop_params(X, y, list_cat, grps=grps_merged, param_grid=param_grid, n_jobs=n_jobs, k_fold=k_fold,
            title_res="Results_variables/Result_smoke_permfit_smoke.csv")
